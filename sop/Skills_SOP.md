...
|-------|---------|---------------|
| `/concept` | Project-level ideation — produce a concept brief | Phase 0: Foundation |
| `/define` | Distill concept into full project definition | Phase 0: Foundation |
| `/strategy-create` | Bootstrap strategy docs from project definition | Phase 0: Foundation |
| `/roadmap-create` | Create ROADMAP.md and populate Linear | Phase 0: Foundation |
| `/wave-plan` | Select and manage execution waves | Phase 0: Foundation / Ongoing |
| `/roadmap-review` | Pre-pipeline health check (Phase 0 gate) | Phase 0 → Phase 1 gate |
| `/brainstorm` | Feature-level feasibility exploration | Phase 1: Definition |
| `/brainstorm-review` | Triage untriaged Linear issues | Phase 1: Definition |
| `/light-spec` | Structured spec generation with agent review | Phase 1: Definition |
| `/launch` | Formalized trigger: gates → routing → execution | Phase 2: Launch & Planning |
| `/linear-todo-runner` | Batch execution of specced issues | Phase 3: Execution |
...
| `/strategy-sync` | Update Strategy docs after shipping | Phase 5: Documentation |
| `/pr-fix` | Precision PR review + fix workflow | Anytime |
| `/security-review` | Security review | Anytime |
| `/spec-validator` | Validate spec completeness | Phase 1: Definition |
| `/skill-index` | Sync skill index after changes | Anytime |
| `/task-processor` | Process Linear tasks systematically | Phase 3: Execution |
| `/startup` | Full project bootstrap orchestrator | Phase 0 (all steps) |
